...
> 💡 _While Java + Spring Boot remains my primary backend focus, I also explored MERN-based projects post-training to reinforce architecture and API development skills._   
